...
└── tools/
    ├── ast-grep/          # 35 code quality rules across 6 languages
...
35 code quality rules for Elixir, Go, Nix, Python, Rust, and TypeScript. Catches security issues (hardcoded secrets, SQL injection, XSS, atom table exhaustion), reliability bugs (swallowed errors, empty critical sections), impure Nix patterns, and bad practices (print statements, `as any`).
